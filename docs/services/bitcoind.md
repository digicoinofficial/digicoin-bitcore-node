...
The Digicoin Service is a Node.js interface to [Digicoin Core](https://github.com/digicoin/digicoin-core) for querying information about the digicoin block chain. It will manage starting and stopping `digicoind` or connect to several running `digicoind` processes. It uses an instance of a Digicoin with additional indexes enabled for querying information about addresses and blocks. Results are cached for performance and there are several additional API methods added for common queries.
