...
**Note**: To install services [insight-api](https://github.com/digicoin/digicoin-insight-api) and [insight-ui](https://github.com/digicoin/digicoin-insight-ui) you'll need to clone the repositories locally.
