...
var BASE_PACKAGE = {
  description: 'A full Digicoin node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    /*
    'digicoin-bitcore-lib': '^' + bitcore.version,
    'digicoin-bitcore-node': version
    */
    'digicoin-bitcore-lib': 'https://github.com/digicoinofficial/digicoin-bitcore-lib',
    'digicoin-bitcore-node': 'https://github.com/digicoinofficial/digicoin-bitcore-node'
